/*
 * $Id: support.h,v 1.3 2011/08/19 05:32:24 gregs Exp $
 */
...
#define UNIX_LAST_MODULE         26	/* the last module in the call stack */
/* -------------- */
...
/* UNIX_LAST_MODULE */     {"last_module",     _ALL_ON_,          0200000000},
};
