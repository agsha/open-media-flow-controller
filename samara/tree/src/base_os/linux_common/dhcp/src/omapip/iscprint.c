...
/* $Id: iscprint.c,v 1.1.1.1 2012/02/10 03:37:49 et Exp $ */
...
"$Id: iscprint.c,v 1.1.1.1 2012/02/10 03:37:49 et Exp $ Copyright (c) 2004 Internet Systems Consortium, Inc.  All rights reserved.";
#endif
