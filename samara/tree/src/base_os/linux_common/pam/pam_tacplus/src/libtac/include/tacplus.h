...
#define TAC_PLUS_CLEAR     0x1		/* packet is not encrypted */
    ...
    u_int session_id;		/* session identifier FIXME: Is this needed? */
...
#define TAC_PLUS_PRIV_LVL_USER 0x1
#define TAC_PLUS_PRIV_LVL_ROOT 0xf
...
#define AUTHEN_METH_NOTSET           0x00
