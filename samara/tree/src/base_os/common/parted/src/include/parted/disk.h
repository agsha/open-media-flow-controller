...
struct _PedPartition {
        ...
        const PedFileSystemType* fs_type;	/**< The type of file system on the partition.
						  	NULL if unknown. */
        PedPartition*           part_list;      /**< Only used for an extended partition.
						  	The list of logical partitions 
						  	(and free space and metadata within 
