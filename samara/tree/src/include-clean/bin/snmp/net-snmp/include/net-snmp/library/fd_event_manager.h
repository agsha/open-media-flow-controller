...
#include "../../../../tms/sn_shared.h"

/*
 * TMS change:
 * NET-SNMP defined NUM_EXTERNAL_FDS as 32.  It seems to only
 * actually use about 10 of these in practice, but we'll leave the
 * number alone to be conservative.  We need a bunch of FDs of our
 * own, and NUM_GCL_EXTRA_FDS is the number we will use.  We keep
 * our number of open GCL sessions down to this number.
 */
#define NUM_EXTERNAL_FDS (32 + NUM_GCL_EXTRA_FDS)
