...
extern          "C" {
     ...
     * On success, returns 1, and request ID sent is returned via last
     * parameter (if provided).  On failure, returns 0.
     * The pdu is freed by snmp_send() unless a failure occured.
     */
    int             snmp_send(netsnmp_session *, netsnmp_pdu *, int *);
    ...
    int             snmp_sess_send(void *, netsnmp_pdu *, int *);
