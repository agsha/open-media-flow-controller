...
# If MFC opensource build (IE no source under svn), set STANDALONE=yes
## STANDALONE=no
STANDALONE=yes
...
Syntax()
{
    ...
    echo "[options] [fresh|clean] [all|default|none|[[basic][install][release][release-opensource][mfgcd]]"
    ...
    echo "--sums      : Calculate sums of all the files when the build is done."
...
Parse_Params()
{
  ...
  do
    ...
    none)               DO_LIST=
                        ;;
    basic|install|release|release-opensource|mfgcd|mfgusb)
