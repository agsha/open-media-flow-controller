 ...
 *---------------------------------------------------------------------------*/
int
cli_l4proxy_cmds_init(
        const lc_dso_info *info,
        const cli_module_context *context);

static int cli_l4proxy_show(
    void *data,
...
static int cli_l4proxy_domain_show(
    void *data,
    const cli_command *cmd,
    const tstr_array *cmd_line,
    const tstr_array *params);
        ...
        const cli_module_context *context)
{
    ...
    cmd->cc_help_descr =            N_("Disables domain-filter");
    cmd->cc_flags =		    ccf_terminal;
    cmd->cc_capab_required =	    ccp_set_rstr_curr;
    cmd->cc_exec_operation =	    cxo_set;
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/enable";
    ...
    cmd->cc_capab_required  =	ccp_set_rstr_curr;
    cmd->cc_exec_operation  =	cxo_set;
    cmd->cc_exec_name	    =	"/nkn/l4proxy/config/tunnel-list/enable";
    cmd->cc_exec_value	    =	"true";
    cmd->cc_exec_type	    =	bt_bool;
    cmd->cc_revmap_type	    =	crt_auto;
    cmd->cc_revmap_order    =	cro_mgmt;
    ...
    cmd->cc_capab_required  =	ccp_set_rstr_curr;
    cmd->cc_exec_operation  =	cxo_set;
    cmd->cc_exec_name	    =	"/nkn/l4proxy/config/cache-fail/action";
    cmd->cc_exec_value	    =	"0";
    ...
    cmd->cc_flags	    =	ccf_terminal;
    cmd->cc_capab_required  =	ccp_query_basic_curr;
    cmd->cc_exec_callback   =	cli_l4proxy_domain_show;
    /* 1 means white-list */
    ...
    cmd->cc_capab_required =	    ccp_set_rstr_curr;
    cmd->cc_exec_operation =	    cxo_set;
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/wlist/enable";
    cmd->cc_exec_value =	    "true";
    cmd->cc_exec_type =		    bt_bool;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =	    ccp_set_rstr_curr;
    cmd->cc_exec_operation =	    cxo_set;
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/blist/enable";
    cmd->cc_exec_value =	    "true";
    cmd->cc_exec_type =		    bt_bool;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =	    ccp_set_rstr_curr;
    cmd->cc_exec_operation =	    cxo_set;
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/wlist/threshold";
    cmd->cc_exec_value =	    "$1$";
    cmd->cc_exec_type =		    bt_uint32;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/wlist/ip/$1$";
    ...
    cmd->cc_capab_required =	    ccp_set_rstr_curr;
    cmd->cc_exec_operation =	    cxo_create;
    cmd->cc_exec_name =		    "/nkn/l4proxy/config/blist/ip/$1$";
    cmd->cc_exec_value =	    "$1$"; /* 1 means whitelist */
    cmd->cc_exec_type =		    bt_string;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =        ccp_set_rstr_curr;
    cmd->cc_exec_operation =        cxo_set;
    cmd->cc_exec_name =             "/nkn/l4proxy/config/use_client_ip";
    cmd->cc_exec_value =            "$1$";
    cmd->cc_exec_type =             bt_uint32;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =        ccp_set_rstr_curr;
    cmd->cc_exec_operation =        cxo_set;
    cmd->cc_exec_name =             "/nkn/l4proxy/config/del_ip_list";
    cmd->cc_exec_value =            "$1$";
    cmd->cc_exec_type =             bt_string;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =        ccp_set_rstr_curr;
    cmd->cc_exec_operation =        cxo_set;
    cmd->cc_exec_name =             "/nkn/l4proxy/config/add_cacheable_ip_list";
    cmd->cc_exec_value =            "$1$";
    cmd->cc_exec_type =             bt_string;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
    ...
    cmd->cc_capab_required =        ccp_set_rstr_curr;
    cmd->cc_exec_operation =        cxo_set;
    cmd->cc_exec_name =             "/nkn/l4proxy/config/add_block_ip_list";
    cmd->cc_exec_value =            "$1$";
    cmd->cc_exec_type =             bt_string;
    cmd->cc_revmap_type =           crt_auto;
    cmd->cc_revmap_order =          cro_mgmt;
	...
	"/nkn/l4proxy/config/*",
	"/nkn/l4proxy/config/blist/enable",
	"/nkn/l4proxy/config/blist/ip/*",
	"/nkn/l4proxy/config/wlist/enable",
	"/nkn/l4proxy/config/wlist/threshold",
	"/nkn/l4proxy/config/wlist/ip/*",
	"/nkn/l4proxy/config/use_client_ip",
	"/nkn/l4proxy/config/add_block_ip_list",
	"/nkn/l4proxy/config/add_cacheable_ip_list",
	"/nkn/l4proxy/config/del_ip_list",
    };
    ...
    const tstr_array *params)
{
    ...
    if (white_list == 0) {
	/* this is black list */
	snprintf(node_name, sizeof(node_name), "/nkn/l4proxy/config/blist/ip/*");
    } else {
	/* this is white list */
	snprintf(node_name, sizeof(node_name), "/nkn/l4proxy/config/wlist/ip/*");
    }
    ...
    const tstr_array *params)
{
	...
	err = cli_printf_query (
            _("  Domain-Filter : #n:enable~/nkn/l4proxy/config/enable#\n"));
        bail_error(err);

	err = cli_printf_query (
            _("  Tunnel All Connections : "
			"#n:enable~/nkn/l4proxy/config/tunnel-list/enable#\n"));
        bail_error(err);

	err = mdc_get_binding(cli_mcc, NULL, NULL, false, &binding,
		"/nkn/l4proxy/config/cache-fail/action", NULL);
                        ...
                        const tstr_array *params)
{
    ...
    err = cli_printf("WARNING: please use service restart mod-domain-filter command for changes to take effect\n");
    bail_error(err);
