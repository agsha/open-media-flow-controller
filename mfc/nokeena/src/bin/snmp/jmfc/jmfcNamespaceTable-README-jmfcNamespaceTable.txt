...
------------------------------------------------------------------------
  ...
  the jmfcNamespaceTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jmfcNamespaceTable.m2d, and then re-running mib2c.
    ...
    in the jmfcNamespaceTable.h header.
    ...
    will be generated:
      ...
      jmfcNamespaceTable_allocate_data
      jmfcNamespaceTable_release_data
    ...
    will be generated:
      ...
      jmfcNamespaceTable_rowreq_ctx_init
      jmfcNamespaceTable_rowreq_ctx_cleanup
 ...
 Index(es) for the jmfcNamespaceTable table
  ------------------------------------------------------------
  The index(es) for the jmfcNamespaceTable table are:
...
************************************************************************
jmfcNamespaceTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jmfcNamespaceTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jmfcNamespaceTable_data_access.[c|h]
------------------------------------------------------------------------
  The jmfcNamespaceTable_data_access file contains the interface to your data in
  ...
  FUNC : jmfcNamespaceTable_indexes_set
  WHERE: jmfcNamespaceTable_data_access.c
...
File: jmfcNamespaceTable_enums.h
------------------------------------------------------------------------
...
File: jmfcNamespaceTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceUID_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceResourcePool_get



File: jmfcNamespaceTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jmfcNamespaceTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jmfcNamespaceTable table.

To watch the flow of the jmfcNamespaceTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jmfcNamespaceTable
        verbose:jmfcNamespaceTable
        internal:jmfcNamespaceTable

e.g.
        snmpd -f -Le -DjmfcNamespaceTable,verbose:jmfcNamespaceTable,internal:jmfcNamespaceTable
...
/*---------------------------------------------------------------------
 * JUNIPER-MFC-MIB::jmfcNamespaceEntry.jmfcNamespaceName
 * jmfcNamespaceName is subid 2 of jmfcNamespaceEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.2636.1.2.1.4.1.1.2
 * Description:
The namespace name, as configured by the administrator
            while creating the namespace.
 *
 * Attributes:
