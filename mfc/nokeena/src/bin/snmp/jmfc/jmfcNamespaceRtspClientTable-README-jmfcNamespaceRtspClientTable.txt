************************************************************************
jmfcNamespaceRtspClientTable README
------------------------------------------------------------------------
  ...
  the jmfcNamespaceRtspClientTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jmfcNamespaceRtspClientTable.m2d, and then re-running mib2c.
    ...
    in the jmfcNamespaceRtspClientTable.h header.
    ...
    will be generated:
      ...
      jmfcNamespaceRtspClientTable_allocate_data
      jmfcNamespaceRtspClientTable_release_data
    ...
    will be generated:
      ...
      jmfcNamespaceRtspClientTable_rowreq_ctx_init
      jmfcNamespaceRtspClientTable_rowreq_ctx_cleanup
 ...
 Index(es) for the jmfcNamespaceRtspClientTable table
  ------------------------------------------------------------
  The index(es) for the jmfcNamespaceRtspClientTable table are:
...
************************************************************************
jmfcNamespaceRtspClientTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jmfcNamespaceRtspClientTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jmfcNamespaceRtspClientTable_data_access.[c|h]
------------------------------------------------------------------------
  The jmfcNamespaceRtspClientTable_data_access file contains the interface to your data in
  ...
  FUNC : jmfcNamespaceRtspClientTable_indexes_set
  WHERE: jmfcNamespaceRtspClientTable_data_access.c
...
File: jmfcNamespaceRtspClientTable_enums.h
------------------------------------------------------------------------
...
File: jmfcNamespaceRtspClientTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientRequests_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientResponses_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientCacheHit_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientCacheMiss_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientCachePartialHit_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientInBytes_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientOutBytes_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientActiveConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientIdleConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientStatus2xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientStatus3xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientStatus4xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspClientStatus5xx_get



File: jmfcNamespaceRtspClientTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
jmfcNamespaceRtspClientTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jmfcNamespaceRtspClientTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jmfcNamespaceRtspClientTable table.

To watch the flow of the jmfcNamespaceRtspClientTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jmfcNamespaceRtspClientTable
        verbose:jmfcNamespaceRtspClientTable
        internal:jmfcNamespaceRtspClientTable

e.g.
        snmpd -f -Le -DjmfcNamespaceRtspClientTable,verbose:jmfcNamespaceRtspClientTable,internal:jmfcNamespaceRtspClientTable
