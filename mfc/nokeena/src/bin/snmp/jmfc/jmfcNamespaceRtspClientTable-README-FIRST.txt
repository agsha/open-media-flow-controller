...
begin with the jmfcNamespaceRtspClientTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceRtspClientTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f jmfcNamespaceRtspClientTable_Makefile


  File    : jmfcNamespaceRtspClientTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   jmfcNamespaceRtspClientTable-README-jmfcNamespaceRtspClientTable.txt
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceRtspClientTable_interface.c
