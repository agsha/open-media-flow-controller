...
begin with the jmfcNamespaceHttpServerTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceHttpServerTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f jmfcNamespaceHttpServerTable_Makefile


  File    : jmfcNamespaceHttpServerTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   jmfcNamespaceHttpServerTable-README-jmfcNamespaceHttpServerTable.txt
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceHttpServerTable_interface.c
