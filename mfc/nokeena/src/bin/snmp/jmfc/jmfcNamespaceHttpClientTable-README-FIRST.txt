...
begin with the jmfcNamespaceHttpClientTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceHttpClientTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f jmfcNamespaceHttpClientTable_Makefile


  File    : jmfcNamespaceHttpClientTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   jmfcNamespaceHttpClientTable-README-jmfcNamespaceHttpClientTable.txt
...
------------------------------------------------------------------------
  ...
  File    : jmfcNamespaceHttpClientTable_interface.c
