************************************************************************
jmfcNamespaceRtspServerTable README
------------------------------------------------------------------------
  ...
  the jmfcNamespaceRtspServerTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jmfcNamespaceRtspServerTable.m2d, and then re-running mib2c.
    ...
    in the jmfcNamespaceRtspServerTable.h header.
    ...
    will be generated:
      ...
      jmfcNamespaceRtspServerTable_allocate_data
      jmfcNamespaceRtspServerTable_release_data
    ...
    will be generated:
      ...
      jmfcNamespaceRtspServerTable_rowreq_ctx_init
      jmfcNamespaceRtspServerTable_rowreq_ctx_cleanup
 ...
 Index(es) for the jmfcNamespaceRtspServerTable table
  ------------------------------------------------------------
  The index(es) for the jmfcNamespaceRtspServerTable table are:
...
************************************************************************
jmfcNamespaceRtspServerTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jmfcNamespaceRtspServerTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jmfcNamespaceRtspServerTable_data_access.[c|h]
------------------------------------------------------------------------
  The jmfcNamespaceRtspServerTable_data_access file contains the interface to your data in
  ...
  FUNC : jmfcNamespaceRtspServerTable_indexes_set
  WHERE: jmfcNamespaceRtspServerTable_data_access.c
...
File: jmfcNamespaceRtspServerTable_enums.h
------------------------------------------------------------------------
...
File: jmfcNamespaceRtspServerTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerRequests_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerResponses_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerInBytes_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerOutBytes_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerActiveConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerIdleConns_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerStatus2xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerStatus3xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerStatus4xx_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcNamespaceRtspServerStatus5xx_get



File: jmfcNamespaceRtspServerTable_data_set.c
------------------------------------------------------------------------
...
************************************************************************
jmfcNamespaceRtspServerTable Reference
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jmfcNamespaceRtspServerTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jmfcNamespaceRtspServerTable table.

To watch the flow of the jmfcNamespaceRtspServerTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jmfcNamespaceRtspServerTable
        verbose:jmfcNamespaceRtspServerTable
        internal:jmfcNamespaceRtspServerTable

e.g.
        snmpd -f -Le -DjmfcNamespaceRtspServerTable,verbose:jmfcNamespaceRtspServerTable,internal:jmfcNamespaceRtspServerTable
