...
------------------------------------------------------------------------
  ...
  the jmfcInterfaceTable table.  The agent will start by looking for the right
  ...
  file defaults/table-jmfcInterfaceTable.m2d, and then re-running mib2c.
    ...
    in the jmfcInterfaceTable.h header.
    ...
    will be generated:
      ...
      jmfcInterfaceTable_allocate_data
      jmfcInterfaceTable_release_data
 ...
 Index(es) for the jmfcInterfaceTable table
  ------------------------------------------------------------
  The index(es) for the jmfcInterfaceTable table are:
...
************************************************************************
jmfcInterfaceTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the jmfcInterfaceTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: jmfcInterfaceTable_data_access.[c|h]
------------------------------------------------------------------------
  The jmfcInterfaceTable_data_access file contains the interface to your data in
  ...
  FUNC : jmfcInterfaceTable_indexes_set
  WHERE: jmfcInterfaceTable_data_access.c
...
File: jmfcInterfaceTable_enums.h
------------------------------------------------------------------------
...
File: jmfcInterfaceTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : jmfcIfSpeed_get



File: jmfcInterfaceTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      jmfcInterfaceTable table.

      Conversely, the examples below may not include some functions that
      were generated for the jmfcInterfaceTable table.

To watch the flow of the jmfcInterfaceTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        jmfcInterfaceTable
        verbose:jmfcInterfaceTable
        internal:jmfcInterfaceTable

e.g.
        snmpd -f -Le -DjmfcInterfaceTable,verbose:jmfcInterfaceTable,internal:jmfcInterfaceTable
...
/*---------------------------------------------------------------------
 * JUNIPER-MFC-MIB::jmfcInterfaceEntry.jmfcIfIndex
 * jmfcIfIndex is subid 1 of jmfcInterfaceEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.2636.1.2.1.2.2.1.1.1
 * Description:
