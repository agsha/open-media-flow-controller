...
begin with the jmfcInterfaceTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : jmfcInterfaceTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f jmfcInterfaceTable_Makefile


  File    : jmfcInterfaceTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   jmfcInterfaceTable-README-jmfcInterfaceTable.txt
...
------------------------------------------------------------------------
  ...
  File    : jmfcInterfaceTable_interface.c
