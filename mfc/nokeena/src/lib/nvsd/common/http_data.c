...
mime_header_descriptor_t http_known_headers[MIME_HDR_MAX_DEFS] = {
    ...
    {"X-NKN-Cluster-Tproxy", 20, MIME_HDR_X_NKN_CLUSTER_TPROXY, DT_STRING, 0},
    {"X-NKN-Origin-IP", 15, MIME_HDR_X_NKN_ORIGIN_IP, DT_STRING, 0},
    {"X-NKN-MD5-Checksum", 18, MIME_HDR_X_NKN_MD5_CHECKSUM, DT_STRING, 0},
    {"X-NKN-Cache-Index",  17, MIME_HDR_X_NKN_CACHE_INDEX, DT_STRING, 0},
    {"X-NKN-Uncompressed-Length", 25, MIME_HDR_X_NKN_UNCOMPRESSED_LENGTH, DT_STRING, 0},
    {"X-NKN-User-Agent", 16, MIME_HDR_X_NKN_USER_AGENT, DT_STRING, 0},
...
char http_end2end_header[MIME_HDR_MAX_DEFS] = 
{
    ...
    1, /* MIME_HDR_X_NKN_CLUSTER_TPROXY */
    0, /* MIME_HDR_X_NKN_ORIGIN_IP */
    0, /* MIME_HDR_X_NKN_MD5_CHECKSUM */
    0, /* MIME_HDR_X_NKN_CACHE_INDEX */
    0, /* MIME_HDR_X_NKN_UNCOMPRESSED_LENGTH */
    0, /* MIME_HDR_X_NKN_USER_AGENT */
};
...
char http_allowed_304_header[MIME_HDR_MAX_DEFS] = 
{
    ...
    0,
    0, /* MIME_HDR_X_NKN_PE_HOST_HDR */
    0, /* MIME_HDR_X_NKN_CLUSTER_TPROXY */
    0, /* MIME_HDR_X_NKN_ORIGIN_IP */
    0, /* MIME_HDR_X_NKN_MD5_CHECKSUM */
    0, /* MIME_HDR_X_NKN_CACHE_INDEX */
    0, /* MIME_HDR_X_NKN_UNCOMPRESSED_LENGTH */
