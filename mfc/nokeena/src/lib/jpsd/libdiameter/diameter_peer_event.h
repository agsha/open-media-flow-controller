/*
 * @file diameter_peer_event.h
 * @brief
 * diameter_peer_event.h - declarations for diameter peer event functions
 *
...
#ifndef _DIAMETER_PEER_EVENT_H
#define _DIAMETER_PEER_EVENT_H
...
void diameter_peer_on_incoming_queue_limit_exceeded(
				...
				diameter_peer_handle peer, uint32_t queue_size);
...
void diameter_peergroup_on_connect_event(
				diameter_peergroup_observer_handle h,
				diameter_peergroup_handle peergroup,
				diameter_peer_handle peer);

void diameter_peergroup_on_disconnect_event(
				diameter_peergroup_observer_handle h,
				diameter_peergroup_handle peergroup,
				diameter_peer_handle peer,
				diameter_peer_disconnect_reason_t reason,
...
void diameter_peergroup_on_failover_event(
				diameter_peergroup_observer_handle h,
				diameter_peergroup_handle peergroup,
				diameter_peer_handle hpeer,
				uint32_t num_retransmitted_requests);

void diameter_peergroup_on_release_event(
				diameter_peergroup_observer_handle h,
				diameter_peergroup_user_handle user_handle);

#endif /* !_DIAMETER_PEER_EVENT_H */
