...
/* MSC LED structure */
typedef struct msc_led_t {
    int first_marvel_bus_number;
    int second_marvel_bus_number;
    void __iomem *first_marvel_regs;
    void __iomem *second_marvel_regs;
    struct timer_list mvs_94xx_led_timer;
