...
/* For CENTOS 6.6 need to define this.  Juniper added */
#define COMPAT_CENTOS66_JUNIPER 1
/* Note: NETIF_F_GSO_GRE is defined in Centos 6.6 in include/linux/netdevice.h */
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(2, 6, 36))
#ifndef COMPAT_CENTOS66_JUNIPER
...
#ifndef COMPAT_CENTOS66_JUNIPER
#if (LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 0))
#if defined(CONFIG_PCI_IOV) && defined(PCI_DEV_FLAGS_ASSIGNED)
