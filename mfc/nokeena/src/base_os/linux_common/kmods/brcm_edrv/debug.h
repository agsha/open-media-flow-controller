...
#define debug_message8(l, fmt, d1, d2, d3, d4, d5, d6, d7, d8) debug_msgx(l, fmt, d1, d2, d3, d4, d5, d6, d7, d8)
...
#define DbgMessage8(_c, _m, _s, _d1, _d2, _d3, _d4, _d5, _d6, _d7, _d8)
...
do { \
        MessageHdr((_c), (_m));                                                 \
        debug_message8((_m), _s, _d1,_d2,_d3,_d4,_d5,_d6,_d7, _d8); \
} while(0)
...
#define debug_message8(fmt, d1, d2, d3, d4, d5, d6, d7, d8) printf(fmt, d1, d2, d3, d4, d5, d6, d7, d8); fflush(stdout);
...
#define DbgMessage8(_c, _m, _s, _d1, _d2, _d3, _d4, _d5, _d6, _d7, _d8)             \
    ...
    {                                                                       \
        MessageHdr((_c), (_m));                                                 \
        debug_message8(_s, _d1,_d2,_d3,_d4,_d5,_d6,_d7,_d8);                        \
    }
// __USER_MODE_DEBUG
#define debug_break() do { \
...
#define DbgMessage8 DbgMessageXX
...
#define DbgMessage8(_c, _m, _s, _d1, _d2, _d3, _d4, _d5, _d6,_d7,_d8)               \
    if(LOG_MSG(_m))                                                             \
    {                                                                           \
        debug_msg(_c, _m, __FILE__, __LINE__, _s, _d1,_d2,_d3,_d4,_d5,_d6,_d7,_d8); \
    }
...
void win_debug_enter_fatal_state();
