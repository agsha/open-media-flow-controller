...
typedef enum {
    ...
    MIME_HDR_X_NKN_CLUSTER_TPROXY, /* Header for Transparent Cluster */
    MIME_HDR_X_NKN_ORIGIN_IP,    /* Origin Server IP */
    MIME_HDR_X_NKN_MD5_CHECKSUM, /* X-NKN-MD5-Checksum header */
    MIME_HDR_X_NKN_CACHE_INDEX,  /* Cache index transferred from cluster Tier 1 node */ 
    MIME_HDR_X_NKN_UNCOMPRESSED_LENGTH,	/*Original content-length of compressed object */
    MIME_HDR_X_NKN_USER_AGENT, /* User Agent from request, for Vary header */
    MIME_HDR_MAX_DEFS
    /*
     ***************************************************************************
